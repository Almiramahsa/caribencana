      ...
      <nav className={`absolute flex items-center justify-between flex-wrap top-5 right-5 z-20 w-2/4 p-6 bg-zinc-800/25    hover:-translate-y-2  transition transform rounded-md  ${toggle ? 'block' : 'hidden'}`}>
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-white mr-4 hover:text-zinc-800/75">
              Home
            </a>
            <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-white mr-4 hover:text-zinc-800/75">
              Knowledge Portal
            ...
            <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-zinc-800/75">
              About
            </a>
          </div>
